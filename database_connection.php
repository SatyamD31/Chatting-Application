<?php
    ...
    // $connect = new PDO("mysql: host=localhost; dbname=id14514335_chat; charset=utf8mb4", "id14514335_satyam", "Database@1290");
    ...
    // fetch chat converations of 2 persons
    ...
    function count_unseen_message($from_user_id, $to_user_id, $connect) {
        // status 1 means message is unseen by user
